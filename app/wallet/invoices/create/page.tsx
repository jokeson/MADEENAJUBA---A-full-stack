      ...
      <div className="flex-1 md:ml-56 lg:ml-56 xl:ml-60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          {checkingWallet ? (
            ...
            <div className="flex items-center justify-center min-h-[60vh]">
              ...
              <div className="mb-6">
                ...
                <p className="text-lg mb-6" style={{ color: '#800000' }}>
                  You need a wallet to create and manage invoices. Complete your KYC application to get approved and receive your digital wallet.
                </p>
              </div>
              <button
            ...
            <>
              {/* Header Row */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 md:mt-30">
                <div>
                                ...
                                <p className="text-sm font-semibold" style={{ color: '#800000' }}>
                                  {invoice.status === "paid" ? (
                                    ...
                                    activeTab === "received"
                                      ...
                                      : invoice.issuerEmail || "Unknown" // Payer sees who they paid
                                  ) : (
                                    // For unpaid invoices, show original roles
                                    activeTab === "received"
                                      ? invoice.issuerEmail || "Unknown" // Recipient sees who sent it
